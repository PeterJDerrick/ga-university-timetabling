...
//http://www.programcreek.com/java-api-examples/index.php?source_dir=programd-master/src/org/aitools/util/math/MersenneTwister.java
...
{ 
  ...
  private static final long serialVersionUID = 1L; 
    ...
    private int iRngMax = 65535;
    private int iRngHalfMax = 32768;
    //-------------------------------------------------------
    ...
    //This will provide a random short from zero up to shMax
    public short nextRndShort(short shMax) {
        
        return (short)(Math.round(this.nextRndDouble() * shMax));
    }
    
    //This will provide a random double between 0 and 1
    public double nextRndDouble() {
     
        return (double)(this.nextShort() + iRngHalfMax) / (double)iRngMax;
    }
